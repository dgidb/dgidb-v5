        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right"><a download href={'data/' + row.date + '/' + row.interactions}>{row.interactions}</a></TableCell>
              <TableCell align="right"><a download href={'data/' + row.date + '/' + row.genes}>{row.genes}</a></TableCell>
              <TableCell align="right"><a download href={'data/' + row.date + '/' + row.drugs}>{row.drugs}</a></TableCell>
              <TableCell align="right"><a download href={'data/' + row.date + '/' + row.interactions}>{row.categories}</a></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
