  ...
  return (
    <div className="about-section-container doc-section">
      <p>
        ...
        that prevent us from redistributing them. Please refer to the Browse
        Sources page for license information for each source.
      </p>
      <p>
      ...
      <p>
        ...
        claims in DGIdb from all sources that were mapped to valid genes. For
        ease of use, we recommend working directly with the API or SQL database
        dump.
      </p>
    </div>
  );
