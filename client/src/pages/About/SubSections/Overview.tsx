  ...
  return (
    <Box className="about-section-container doc-section">
      ...
      <p className="about-citation">
        ...
        with open crowdsource efforts. Freshour S, Kiwala S, Cotto KC, Coffman
        AC, McMichael JF, Song J, Griffith M, Griffith OL, Wagner AH. Nucleic
        Acids Research. 2020 Nov 25; doi: https://doi.org/10.1093/nar/gkaa1084.
        PMID: 33237278
      </p>
