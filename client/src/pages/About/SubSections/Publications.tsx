export const Publications = () => {
  return (
    <div className="publications-section-container doc-section">
      ...
      <div>
        <a>DGIdb 2.0: mining clinically relevant drug-gene interactions.</a>{" "}
      ...
      <div>
        <a>DGIdb: mining the druggable genome.</a> Griffith M, Griffith OL,
        Coffman AC, Weible JV, McMichael JF, Spies NC, Koval J, Das I, Callaway
        MB, Eldred JM, Miller CA, Subramanian J, Govindan R, Kumar RD, Bose R,
        Ding L, Walker JR, Larson DE, Dooling DJ, Smith SM, Ley TJ, Mardis ER,
        Wilson RK. Nature Methods. 2013 Dec;10(12):1209-10. doi:
        https://doi.org/10.1038/nmeth.2689. PMID: 24122041.
      </div>
    </div>
  );
};
