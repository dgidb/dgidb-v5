  ...
  return(
    <div className="faq-section-container doc-section">
      ...
      <div className="faq-item">
        ...
        <div className="faq-answer">Please cite our most recent paper on DGIdb, which can be found on the Publications page.</div>
      </div>
      <div className="faq-item">
        <div className="faq-question">Is DGIdb open source and open access?</div>
        <div className="faq-answer">The source code for DGIdb is open-source and made available under the MIT license. The license is distributed with the source code (DGIdb license). The data used in DGIdb is all open access and where possible made available as raw data dumps in the downloads section.</div>
      </div>
      <div className="faq-item">
      ...
      <div className="faq-item">
        ...
        <div className="faq-answer">The code for DGIdb is available at github.</div>
      </div>
      <div className="faq-item">
      ...
      <div className="faq-item">
        ...
        <p className="faq-answer">Please see the Interaction Score and Query Score page for a detailed explanation of these terms.</p>
      </div>
      <div className="faq-item">
