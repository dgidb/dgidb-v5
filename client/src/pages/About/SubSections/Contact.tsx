export const Contact = () => {
  ...
  return(
    <div className="contact-section-container doc-section">
      <div>
        <p>DGIdb was developed at The McDonnell Genome Institute, Washington University School of Medicine. If you have a source of information related to the druggable genome you would like us to incorporate, please contact us at help@dgidb.org.</p>
